...
async function writeExif(media, data) {
    ...
    if (data) {
        ...
        // 
        const { 
            wra = data.pack_id ? data.pack_id : global.author ? global.author : 'Miss-Shasikala', 
            wrb = data.packname ? data.packname : global.packname ? global.packname : 'Miss Shasikala', 
